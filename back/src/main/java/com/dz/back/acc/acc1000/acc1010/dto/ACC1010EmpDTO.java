...
public class ACC1010EmpDTO {
	...
	private List<ACC1010MauthDTO> mauthList;
	...
	public List<ACC1010MauthDTO> getMauthList() {
		return mauthList;
	}
	public void setMauthList(List<ACC1010MauthDTO> mauthList) {
	...
	public String toString() {
		return "EmpDTO [co_cd=" + co_cd + ", emp_cd=" + emp_cd + ", emp_nm=" + emp_nm + ", emp_id=" + emp_id
				+ ", password=" + password + ", dept_cd=" + dept_cd + ", mauthList="
